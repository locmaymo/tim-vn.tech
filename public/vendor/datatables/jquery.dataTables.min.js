...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"Bạn chưa có bài đăng nào",sInfo:"Hiển thị từ _START_ đến _END_ của _TOTAL_ Mục",sInfoEmpty:"Hiển Thị từ 0 đến 0 của 0 Mục",
sInfoFiltered:"(Lọc từ _MAX_ Mục)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị_MENU_ Mục",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không có kết quả khớp"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
